...
> ⚠️ **Python 3.11 is required.** If the .bat shows an error about Python not found, download and install it from [python.org](https://www.python.org/downloads/) first.
